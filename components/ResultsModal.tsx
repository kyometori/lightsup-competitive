        ...
        <div ref={resultCardRef} className="p-6 bg-slate-900 rounded-t-2xl">
            ...
            <div className="border-t border-slate-700 pt-4 text-center">
                 <div className="flex justify-center items-center flex-wrap gap-2">
                    {gameModes.isRandom && <span className="bg-cyan-500/20 text-cyan-300 text-xs font-semibold px-3 py-1 rounded-full whitespace-nowrap">Random Start</span>}
                    {gameModes.isHard && <span className="bg-red-500/20 text-red-300 text-xs font-semibold px-3 py-1 rounded-full whitespace-nowrap">Hard Mode</span>}
                    {seed && (
